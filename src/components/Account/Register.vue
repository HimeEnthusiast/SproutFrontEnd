    ...
    <div id="registration">
      <form id="reg-form" @submit.prevent="registerUser" method="post">
        ...
        <input
          ...
          required
        />
        <span class="error" id="email-error" v-if="emailError"
