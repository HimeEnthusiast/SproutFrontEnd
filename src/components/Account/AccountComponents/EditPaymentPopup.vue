    ...
    <div id="root">
        <div id="popup">
            ...
            <div id="editable-lines">
                <h3>Card Bearer: </h3>
                <input id="full-name" v-model="cardName" type="text" minlength="1" maxlength="50" required />
                <span class="error" v-if="nameError">Name cannot be empty.</span>

                <h3>Credit Card Number: </h3>
                <input id="ccnumber" v-model="creditNumber" type="number" minlength="16" maxlength="19" required />
                <span class="error" v-if="creditFormatError">Credit card must be a 16-19 digit number.</span>

                <h3>CVV: </h3>
                <input id="cvv" v-model="cardCvv" type="password" minlength="3" maxlength="3" required />
                <span class="error" v-if="cvvFormatError">CVV must be a 3 digit number.</span>
            </div>
        ...
        methods: {
            ...
            editData() {
                ...
                if(creditInput.checkValidity() && nameInput.checkValidity() && cvvInput.checkValidity()) {
                    ...
                    axios.post("http://localhost:8082/edit-user-payment/" + this.id, {
                    ...
                    if(!/\d{16,19}/.test(this.creditNumber) || !creditInput.checkValidity()) {
            ...
            createData() {
                ...
                if(creditInput.checkValidity() && nameInput.checkValidity() && cvvInput.checkValidity()) {
                    axios.post("http://localhost:8082/add-user-payment", {
                        ccNumber: this.creditNumber,
                        cardBearer: this.cardName,
                        cvv: this.cardCvv
                    },
