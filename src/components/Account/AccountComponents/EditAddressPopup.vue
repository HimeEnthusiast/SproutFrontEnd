    ...
    <div id="popup">
      ...
      <div id="editable-lines">
        ...
        <input
          ...
          required
        />
        <span class="error" v-if="postalFormatError"
          >Postal Code must be in Canadian format. ex. A1B 2C3</span
        >
      </div>
  ...
  methods: {
    ...
    editData() {
      ...
      if (
        ...
        axios
          .post(
            "http://localhost:8082/edit-user-address/" + this.id,
            {
              address1: this.line1,
              address2: this.line2,
              city: this.cit,
        ...
        if (
          postalField.value == "" ||
          postalField.value == " " ||
          !/([ABCEGHJKLMNPRSTVXY][0-9][A-Z][ ]*[0-9][A-Z][0-9])/.test(
            postalField.value
          )
        ) {
    ...
    createData() {
      ...
      if (
        ...
        axios
          .post(
            "http://localhost:8082/add-user-address",
            {
              address1: this.line1,
              address2: this.line2,
              city: this.cit,
